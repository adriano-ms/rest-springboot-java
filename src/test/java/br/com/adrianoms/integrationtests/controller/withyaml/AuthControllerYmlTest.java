package br.com.adrianoms.integrationtests.controller.withyaml;
...
import br.com.adrianoms.integrationtests.controller.withyaml.mapper.YMLMapper;
	...
	public void testSignin() throws JsonProcessingException {
		...
		tokenVO = 
				given()
					...
					.then()
						.statusCode(200)
					.extract().body().as(TokenVO.class, mapper);
