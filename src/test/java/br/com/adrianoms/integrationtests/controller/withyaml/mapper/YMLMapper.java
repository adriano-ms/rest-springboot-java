package br.com.adrianoms.integrationtests.controller.withyaml.mapper;
...
public class YMLMapper implements ObjectMapper{
	...
	public Object deserialize(ObjectMapperDeserializationContext context) {
		try {
			...
			return objectMapper.readValue(context.getDataToDeserialize().asString(), typeFactory.constructType(type));
